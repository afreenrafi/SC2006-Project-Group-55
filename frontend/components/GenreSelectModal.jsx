...
const GenreSelectModal = ({ modalTitle, modalVisible, onRequestClose, oneOptPress, twoOptPress, threeOptPress, fourOptPress, optOne, optTwo, optThree, optFour }) => {
  ...
  return (
    ...
    >
        ...
        <View style={styles.modalView}>
            ...
            <TouchableOpacity style={styles.modalItem} onPress={threeOptPress}>
                <StyledText size={20} textContent={optThree} fontColor="#FFF"/>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalItem} onPress={fourOptPress}>
                <StyledText size={20} textContent={optFour} fontColor="#FFF"/>
            </TouchableOpacity>
            </View>
        </View>
        </View>
